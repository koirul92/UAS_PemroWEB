...
<div class="container" align="center">
  <div align="center" style="width:400px;margin-top:5%;">
    ...
    <h3 align="center"><span class="glyphicon glyphicon-home"></span> Sistem Pengaduan Infrastruktur Rusak</h3>
    <hr>
    <?php if(isset($error)){
    ?>
    ...
    ?>
      ...
      <a href="masy/masy_home.php" type="button" class="btn btn-block btn-info">Ajukan Pengaduan</a>
    </form>
  </div>
</div>
